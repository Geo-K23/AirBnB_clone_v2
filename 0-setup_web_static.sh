...
# making directories for the deployment using -p to create all parent directories if not existing
sudo mkdir -p /data/web_static/releases/test 
sudo mkdir -p /data/web_static/shared

# Giving ownership of the /data/ directory to the ubuntu user 
sudo chown -R ubuntu /data/

# Giving group ownership of the /data/ directory to the ubuntu user
sudo chgrp -R ubuntu /data/

# creating a test HTML file
echo "Alx School" > /data/web_static/releases/test/index.html

# creating a symbolic link to the test HTML file
